...
/**
 *  \brief  Flags to set on QtWayland windows to integrate with the native window assetManager.
 *
 ...
 *  turn it off to avoid the window assetManager thinking the app is hung.
 ...
 *    "1"       - Enable XRandR
 *
 *  By default SDL will not use XRandR because of window assetManager issues.
 */
