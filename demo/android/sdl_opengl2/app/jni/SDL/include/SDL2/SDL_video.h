...
typedef enum
{
    ...
    SDL_WINDOWEVENT_CLOSE,          /**< The window assetManager requests that the window be closed */
 ...
 * the window assetManager, etc, and determines the available display modes and
 ...
 * system window assetManager (a title bar, borders, etc), but for some apps, it
