...
#define NK_RGFW_GL4_IMPLEMENTATION
#define NK_KEYSTATE_BASED_INPUT
#include "nuklear.h"
#include "nuklear_rgfw_gl4.h"
...
int main(void)
{
    ...
    ctx = nk_RGFW_init(win, NK_RGFW_INSTALL_CALLBACKS, MAX_VERTEX_BUFFER, MAX_ELEMENT_BUFFER);
     ...
     * IF you need the GL resource id use: nk_RGFW_get_tex_ogl_id() */
    ...
    tex_index = nk_RGFW_create_texture(pixels, tex_width, tex_height);
